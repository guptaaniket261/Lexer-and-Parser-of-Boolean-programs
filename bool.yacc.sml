...
"\
\\001\000\001\000\016\000\005\000\015\000\006\000\014\000\007\000\013\000\
...
\\032\000\000\000\
\\033\000\000\000\
\\034\000\003\000\010\000\004\000\009\000\010\000\008\000\013\000\007\000\
\\015\000\006\000\000\000\
\\035\000\000\000\
...
"\008\000\000\000\006\000\008\000\
\\017\000\002\000\002\000\002\000\
\\018\000\002\000\002\000\002\000\
\\002\000\002\000\009\000\007\000\
\\005\000\003\000\016\000\011\000\
\\015\000\013\000\014\000\012\000\
\\019\000\002\000\004\000\002\000\
\\010\000\001\000"
val gotoT =
"\
...
\\000\000\
\\000\000\
\\002\000\003\000\003\000\015\000\004\000\001\000\000\000\
\\000\000\
...
datatype svalue = VOID | ntVOID of unit ->  unit
 ...
 | formula of unit ->  (string) | statementList of unit ->  (string)
...
fn (i392,defaultPos,stack,
    (()):arg) =>
case (i392,stack)
of  ( 0, ( ( _, ( MlyValue.statementList statementList1, 
statementList1left, statementList1right)) :: rest671)) => let val  
result = MlyValue.program (fn _ => let val  (statementList as 
statementList1) = statementList1 ()
 in (
if (statementList="statementList: eps") then NONE else SOME (statementList ^ ", program: statementList")
)
end)
 in ( LrTable.NT 0, ( result, statementList1left, statementList1right)
, rest671)
end
|  ( 1, ( ( _, ( MlyValue.statementList statementList1, _, 
statementList1right)) :: ( _, ( MlyValue.statement statement1, 
statement1left, _)) :: rest671)) => let val  result = 
MlyValue.statementList (fn _ => let val  (statement as statement1) = 
statement1 ()
 val  (statementList as statementList1) = statementList1 ()
 in (
statement ^ ", " ^ statementList ^ ", statementList: statement statementList"
)
end)
 in ( LrTable.NT 2, ( result, statement1left, statementList1right), 
rest671)
end
|  ( 2, ( rest671)) => let val  result = MlyValue.statementList (fn _
 => ("statementList: eps"))
